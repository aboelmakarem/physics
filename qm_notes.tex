...
\begin{frame}
  ...
  \vspace{1mm}
  A Quantum Mechanical system consists of a number $N$ of particles and its state is represented by a number $M$ of kets $\ket{\psi_i} : i = 1 ... M$, all in the same Hilbert space $H_x$ (position Hilbert space)
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item The spin variables are represented by spin operators $S_i$
    \end{itemize}
