...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item $\psi(x_i,s_j)$ is the projection of $\ket{\psi} on $\ket{x_i,s_j}$ is $\braket{x_i,s_j}{\psi} = \Sigma^{M}_{j = 1} \int_{\Omega} \psi(x_l,s_m) \braket{x_i,s_j}{x_l,s_m} d\Omega = \psi(x_i,s_j)$
  \end{itemize}
