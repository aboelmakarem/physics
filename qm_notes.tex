...
\begin{frame}
  ...
  \end{itemize}
  The position operator $X_i$ eigenkets $\ket{x_i} \implies X_i \ket{x_i} = x_i \ket{x_i} \implies \braket{x}{X_i \psi} = \bra{x X_i} \ket{\psi} = x_i \braket{x}{\psi} = x_i \psi$
  \begin{itemize}
    \item The action of the position operator $X_i$ on a ket $\ket{\psi}$ is to multiply it by the coordinate $x_i$: $X_i \ket{\psi} = x_i \ket{\psi}$
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
    \item Unentangled state: $\ket{\psi}$ is the outer product of kets in $H_{xi}$ and $H_{sj}$ : $\ket{\psi} = \ket{\psi_{x1}} \otimes \ket{\psi_{x2}} \otimes ... \otimes \ket{\psi_{xn}} \otimes \ket{\psi_{s1}} \otimes \ket{\psi_{s2}} \otimes ... \otimes \ket{\psi_{sm}}$
...
\begin{frame}
  ...
  \vspace{1mm}
  For an infinitesimal translation in space $\epsilon$ in the $i$ direction: $x_j \to x_j + \delta_{ij} \epsilon$, $s_i \to s_i$. Upon transformation:
  \begin{itemize}
